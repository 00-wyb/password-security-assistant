...
with col2:
    evaluate_btn = st.button("📊 完整评估", type="secondary", use_container_width=True)
        ...
        with st.spinner("正在分析..."):
            ...
            with st.container():
                ...
                ">
                    ...
                    <p style="color: #334155; line-height: 1.6;">{ai_result['risk_explanation']}</p>
                </div>
                """, unsafe_allow_html=True)
                ...
                ">
                    ...
                    <p style="color: #14532d; line-height: 1.6;">{ai_result['improvement_advice']}</p>
                </div>
                """, unsafe_allow_html=True)
                ...
                ">
                    ...
                    <p style="color: #1e3a8a; line-height: 1.6;">{ai_result['security_tips']}</p>
                </div>
                """, unsafe_allow_html=True)
